"""
Django settings for whisperchain project.
...
SECRET_KEY = 'xf0(9k#u5c3ag5!q8i7jwp0%fy!9oknzmsb8h^s+^3+px%tjya'
...
ROOT_URLCONF = 'whisperchain.urls'
...
WSGI_APPLICATION = 'whisperchain.wsgi.application'
...
# Message styling tags (Bootstrap 4)
